...
public class HDR_UMS
{
    ...
    private com.nh.common.dto.header.ums_comm ums_comm = new com.nh.common.dto.header.ums_comm();
    
    public com.nh.common.dto.header.ums_comm getUms_comm() {
    	return ums_comm;
    }	
    
    public void setUms_comm(com.nh.common.dto.header.ums_comm ums_comm) {
    	if(ums_comm == null) {
    		this.ums_comm = new com.nh.common.dto.header.ums_comm();
    	} else {
    		this.ums_comm = ums_comm;
    	}
    }
}
