...
public class WebClientConfig {
	...
	public WebClient webClient() {
		...
		HttpClient httpClient = HttpClient.create()
				...
				.option(ChannelOption.CONNECT_TIMEOUT_MILLIS, 120_000).doOnConnected(conn -> conn
						.addHandlerLast(new ReadTimeoutHandler(180)).addHandlerLast(new WriteTimeoutHandler(180)));

		// Memory 조정: 50M (default 256KB)
